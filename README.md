...
const justin = {
    ...
    skills: {
        ...
        exploring: ["Machine Learning", "Computer Vision", "LLMs"]
    },
    
    currentlyBuilding: "AI-powered applications 🤖",
    askMeAbout: ["Web Dev", "AI/ML", "Open Source", "Tech"]
};
```
...
&nbsp;
<a href="mailto:justinec82@gmail.com">
...
<!-- Easter Egg -->
<div align="center">
  <sub>⭐ Star my repos if you find them useful! | Made with ❤️ by Justin Joseph</sub>
</div>
